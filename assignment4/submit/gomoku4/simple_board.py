...
#            return
    ...
    def get_pattern_moves(self):
        ...
        patternList=[{'xxxx.':{0},'xxx.x':{1},'xx.xx':{2},'x.xxx':{3},'.xxxx':{4}}, #win
                     ...
                     {'xx.x.':{2},'.x.xx':{2},'x.x.x':{1,3},'.xxx.':{0,4}},#weakfour
                     {'o..oo':{2,3},'oo..o':{1,2},'ooo..':{1},'..ooo':{3}},#block part-four
                     {'..xx.':{3},'.xx..':{1},'.x.x.':{2}},
                     {'oo.':{0},'.oo':{2},'o.o':{1}}#block three
                     ]
        ...
        i=0
        while i<8 and not bool(moveSet[i]): i+=1
        if i==8:
            return None
        else:
    ...
    def list_solve_point(self):
        ...
        i=0
        while i<5 and not bool(moveSet[i]):
            i+=1
        if i==5:
            return None
        else:
